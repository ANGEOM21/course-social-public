          ...
          <div class="card-body p-4">
            ...
            <div class="text-center mb-4">
              @if (Auth::user()->img_user)
                <img src="{{ asset('storage/' . Auth::user()->img_user) }}" alt="Foto Profil"
                  class="rounded-circle border border-3 border-primary" width="140" height="140">
              @else
                <img src="https://ui-avatars.com/api/?name={{ Auth::user()->name_user }}&background=0D8ABC&color=fff"
                  alt="Foto Profil" class="rounded-circle border border-3 border-primary" width="140" height="140">
              @endif
            </div>
